...
export class MemStorage implements IStorage {
  ...
  private initializeAiModels() {
    const defaultModels: AiModel[] = [
      ...
      },
      {
        ...
        provider: "grok",
        isActive: true,
        description: "X.AI's conversational AI with real-time insights and wit",
        maxTokens: 131072,
        capabilities: ["conversation", "reasoning", "real-time", "humor"],
        category: "realtime",
      },
      {
        ...
        provider: "grok",
        isActive: true,
        description: "X.AI's multimodal AI with vision capabilities",
        maxTokens: 8192,
        capabilities: ["vision", "image", "multimodal", "reasoning"],
        category: "multimodal",
      },
      {
        id: "gemini-1.5-pro",
        ...
        provider: "gemini",
        isActive: true,
        description: "Google's advanced multimodal AI with extensive context",
        maxTokens: 1048576,
        capabilities: ["multimodal", "vision", "reasoning", "code", "analysis"],
        category: "multimodal",
      },
      {
        id: "multi-model-best",
        name: "Multi-Model Best Response",
        provider: "coordinator",
        isActive: true,
        description: "Combines multiple AI models to provide the best possible response",
        maxTokens: 8192,
        capabilities: ["reasoning", "analysis", "code", "research", "consensus"],
  ...
  async createAiModel(insertModel: InsertAiModel): Promise<AiModel> {
    const model: AiModel = {
      ...
      capabilities: insertModel.capabilities ?? null,
      category: insertModel.category ?? null,
    };
    this.aiModels.set(model.id, model);
    return model;
  }
